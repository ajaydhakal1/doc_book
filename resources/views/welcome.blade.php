            ...
            <div class="container">
                ...
                <div class="row align-items-center mb-5 g-4">
                    <div class="col-md-6 text-center text-md-start">
                        <h2 class="fw-bold mb-3">Are you a <span class="text-primary">Doctor</span>?</h2>
                        <p class="text-muted mb-4">Register to manage your appointments, view patient information,
                            and
                            more.</p>
                    ...
                    <div class="col-md-6">
                        <div class="img-container text-center">
                            <img src="doctor.png" alt="doctor" class="img-fluid rounded-circle shadow">
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center g-4">
                    <div class="col-md-6 order-md-2 text-center text-md-start">
                        <h2 class="fw-bold mb-3">Are you a <span class="text-primary">Patient</span>?</h2>
                        <p class="text-muted mb-4">Register to create your appointments, view doctor information,
                            and
                            more.</p>
                    ...
                    <div class="col-md-6 order-md-1">
                        <div class="img-container text-center">
                            <img src="patient.png" alt="patient" class="img-fluid rounded-circle shadow">
                        </div>
                    </div>
                </div>
            </div>

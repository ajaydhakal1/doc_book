<x-app-layout>
    ...
    <h1 class="text-center text-white text-2xl font-bold py-6">Edit patient</h1>
    <div class="py-6">
        <div class="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md">
            <form action="{{ route('patients.update', $patient->user->id) }}" method="post" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ $patient->user->name }}"
                ...
                <div>
                    <label for="medical_history" class="block text-sm font-medium text-gray-700 mb-2">Medical
                        History</label>
                    <textarea cols="5" name="medical_history" id="medical_history">{{$patient->medical_history}}</textarea>
                </div>
